...
class WaypointUpdater(object):
    ...
    def generate_lane(self):
        ...
        waypoints_publish = self.base_waypoints.waypoints[closest_idx:farthest_idx]

        # rospy.logwarn(self.stopline_wp_idx)

        if (self.stopline_wp_idx == -1) or (self.stopline_wp_idx >= farthest_idx):
            lane.waypoints = waypoints_publish
        else:
            lane.waypoints = self.decelerate_waypoints(waypoints_publish, closest_idx)
        return lane
